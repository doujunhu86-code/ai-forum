...
# 1. 核心配置与初始化
# ==========================================
st.set_page_config(page_title="AI 策略投研 V20.3", page_icon="🎯", layout="wide")
